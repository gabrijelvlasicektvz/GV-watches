                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>{{ __('messages.we_found') }} <strong class="text-brand"> {{$products->total()}}</strong> {{ __('messages.items_for_you_from') }} <strong class="text-brand">{{ $category_name }}</strong> {{ __('messages.category_u') }}</p>
                            </div>
